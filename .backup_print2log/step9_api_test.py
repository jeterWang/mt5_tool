...
print("Step 9: API Interface Refactoring Test")
print("=" * 40)
...
def run_all_tests():
    ...
    if passed == len(tests):
        print("SUCCESS: 所有测试通过！Step 9 API接口重构成功完成")
    elif passed >= len(tests) * 0.8:  # 80%通过率
        print("OK: 大部分测试通过，Step 9基本完成")
    else:
        print("FAIL: 测试失败过多，需要修复问题")
