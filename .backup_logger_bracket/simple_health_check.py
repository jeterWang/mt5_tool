...
logger.info("=" * 60))
logger.info("MT5 Trading System - System Health Check"))
logger.info("=" * 60))
...
def test_step1_logging():
    ...
    try:
        ...
        logger.info("[OK] Step 1: Logging System - Working"))
        return True
    except Exception as e:
        logger.error(f"[FAIL] Step 1: Logging System - Error: {e}"))
        return False
...
def test_step2_type_hints():
    ...
    try:
        ...
        if main_window_path.exists():
            ...
            if has_annotations:
                logger.info("[OK] Step 2: Type Hints - Found in main files"))
            else:
                logger.info("[WARN] Step 2: Type Hints - Limited annotations found"))
        
        results['step2_type_hints'] = True
        logger.info("[OK] Step 2: Type Hints - Files exist"))
        return True
    except Exception as e:
        logger.error(f"[FAIL] Step 2: Type Hints - Error: {e}"))
        return False
...
def test_step3_config_management():
    ...
    try:
        ...
        logger.info("[OK] Step 3: Configuration Management - Working"))
        return True
    except Exception as e:
        logger.error(f"[FAIL] Step 3: Configuration Management - Error: {e}"))
        return False
...
def test_step4_event_system():
    ...
    try:
        ...
        logger.info("[OK] Step 4: Event System - Working"))
        return True
    except Exception as e:
        logger.error(f"[FAIL] Step 4: Event System - Error: {e}"))
        return False
...
def test_step5_interfaces():
    ...
    try:
        ...
        logger.info("[OK] Step 5: Service Interfaces - Working"))
        return True
    except Exception as e:
        logger.error(f"[FAIL] Step 5: Service Interfaces - Error: {e}"))
        return False
...
def test_step6_error_handling():
    ...
    try:
        ...
        logger.error("[OK] Step 6: Error Handling - Working"))
        return True
    except Exception as e:
        logger.error(f"[FAIL] Step 6: Error Handling - Error: {e}"))
        return False
...
def test_step7_controllers():
    ...
    try:
        ...
        logger.info("[OK] Step 7: Controller Layer - Working"))
        return True
    except Exception as e:
        logger.error(f"[FAIL] Step 7: Controller Layer - Error: {e}"))
        return False
...
def test_step8_data_layer():
    ...
    try:
        ...
        logger.info("[OK] Step 8: Data Layer - Working"))
        return True
    except Exception as e:
        logger.error(f"[FAIL] Step 8: Data Layer - Error: {e}"))
        return False
...
def test_step9_api_system():
    ...
    try:
        ...
        logger.info("[OK] Step 9: API System - Working"))
        return True
    except Exception as e:
        logger.error(f"[FAIL] Step 9: API System - Error: {e}"))
        return False
...
def test_integration():
    ...
    try:
        ...
        logger.info("[OK] Integration Test - Structure Valid"))
        return True
    except Exception as e:
        logger.error(f"[FAIL] Integration Test - Error: {e}"))
        return False
...
def main():
    ...
    for test_func in test_functions:
        try:
            ...
            logger.error(f"[ERROR] {test_func.__name__} - Unexpected error: {e}"))
    ...
    for i, (key, status) in enumerate(results.items()):
        ...
        logger.info(f"{icon} {step_names[i]}: {'Passed' if status else 'Failed'}"))
    ...
    if passed >= total * 0.8:  # 80% pass rate is healthy
        ...
        logger.info("Refactoring successful, all major components working"))
    elif passed >= total * 0.6:  # 60% pass rate is usable
        logger.info("System Status: USABLE"))
        logger.info("Most features working, some components may need debugging"))
    else:
        logger.info("System Status: NEEDS REPAIR"))
        logger.info("Multiple critical components have issues"))
